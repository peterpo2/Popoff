    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("c0aa483c-f17e-47a1-98dc-8b5e0c9cba10"), "LTLNA", new DateTime(2025, 12, 11, 16, 32, 15, 632, DateTimeKind.Utc).AddTicks(2711), "Latelina project", false, "Latelina", null, null });

            migrationBuilder.InsertData(
                table: "Servers",
                columns: new[] { "Id", "ConnectionData", "ConnectionType", "CreatedOn", "Description", "HostName", "IpAddress", "IsActive", "IsDeleted", "Name", "UpdatedOn" },
                values: new object[] { new Guid("6f7f8455-43c2-4b61-86a3-a0c24b5c7d77"), null, "LocalShell", new DateTime(2025, 12, 11, 16, 32, 15, 632, DateTimeKind.Utc).AddTicks(2678), "Hetzner production server", "Hetzner-Prod-1", "192.168.1.1", true, false, "Hetzner-Prod-1", null });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedOn", "DisplayName", "Email", "IsDeleted", "PasswordHash", "Role", "UpdatedOn" },
                values: new object[] { new Guid("b4f1bf76-df8a-4b77-9e74-8e5898dd34b8"), new DateTime(2025, 12, 11, 16, 32, 15, 632, DateTimeKind.Utc).AddTicks(2446), "Petar Popov", "admin@popoffcrm.com", false, "10000.00112233445566778899AABBCCDDEEFF.2E3A9A9EE2B5731B504C3DF1F82B07E701E5FF0BF103C636F74FAA111111B049", "Admin", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("832a84f0-5d6d-4f1b-8d96-7716b7a6c1a0"), "https://latelina.popoff.com/api", new DateTime(2025, 12, 11, 16, 32, 15, 632, DateTimeKind.Utc).AddTicks(2748), "/opt/latelina-prod/docker-compose.yml", "latelina-prod", null, "main", false, true, "Prod", new Guid("c0aa483c-f17e-47a1-98dc-8b5e0c9cba10"), new Guid("6f7f8455-43c2-4b61-86a3-a0c24b5c7d77"), "prod", null },
                    { new Guid("b4fa7483-59ae-4d0f-8ebd-0d0a0c6a1b44"), "https://test.latelina.popoff.com/api", new DateTime(2025, 12, 11, 16, 32, 15, 632, DateTimeKind.Utc).AddTicks(2745), "/opt/latelina-test/docker-compose.yml", "latelina-test", null, "develop", false, false, "Test", new Guid("c0aa483c-f17e-47a1-98dc-8b5e0c9cba10"), new Guid("6f7f8455-43c2-4b61-86a3-a0c24b5c7d77"), "test", null }
                });
